...
var CustomDatePickerEditor = (_temp2 = _class = function (_PureComponent) {
    _inherits(CustomDatePickerEditor, _PureComponent);

    function CustomDatePickerEditor() {
        var _ref;

        var _temp, _this, _ret;

        _classCallCheck(this, CustomDatePickerEditor);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CustomDatePickerEditor.__proto__ || Object.getPrototypeOf(CustomDatePickerEditor)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (event) {
            console.log('change event');
            _this.props.commit(event.target.value);
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }

    _createClass(CustomDatePickerEditor, [{
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement('input', { type: 'date', value: this.props.value, onChange: function onChange(event) {
    ...
    return CustomDatePickerEditor;
}(_react.PureComponent), _class.propTypes = {
    value: _propTypes2.default.string,
    commit: _propTypes2.default.func.isRequired
}, _temp2);
exports.default = CustomDatePickerEditor;
...
var _CustomDatePickerEditor = __webpack_require__(/*! ./CustomDatePickerEditor */ "./src/CustomDatePickerEditor.js");

var _CustomDatePickerEditor2 = _interopRequireDefault(_CustomDatePickerEditor);
...
(0, _neosUiExtensibility2.default)('Queo.Forms.CustomEditors:CustomDatePickerEditor', {}, function (globalRegistry) {
    ...
    editorsRegistry.set('Queo.Forms.CustomEditors/CustomDatePickerEditor', {
        component: _CustomDatePickerEditor2.default
    });
});
